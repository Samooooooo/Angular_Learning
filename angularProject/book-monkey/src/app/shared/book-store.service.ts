...
import { Observable, concatMap, from, last, map, of } from 'rxjs';
...
export class BookStoreService {
  ...
  loadBooks(): Observable<undefined> {
    return from(this.booksList).pipe(
      concatMap((book) => this.http.post(`${this.apiUrl}/books/`, book)),
      last(),
      map(() => undefined),
      catchError((error) => {
  ...
  booksList: Book[] = [
    ...
    },
    {
      isbn: '9783864904523',
      title: 'Git',
      authors: ['René Preißel', 'Bjørn Stachmann'],
    ...
    },
    {
      isbn: '9783864907845',
      title: 'GraphQL',
      authors: ['Dominik Kress'],
      published: '2020-10-26T12:00:00.000Z',
      subtitle: 'Eine Einführung in APIs mit GraphQL',
      description:
        'API-Design mit GraphQL für Um- und Einsteiger. In Anwendungen, bei denen es auf komplexe aber dennoch schlanke Datenabfragen ankommt, spielt GraphQL seine Vorteile aus. Dominik Kress gibt Ihnen dafür das nötige Wissen rund um API-Design und die GraphQL-spezifischen Datenmodelle an die Hand.',
    ...
    },
    {
      ...
      description:
        'Dieses Buch ist ein praxisnaher Einstieg für alle, die sich Vue einmal genauer ansehen möchten. ',
